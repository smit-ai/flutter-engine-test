...
class _MyAppState extends State<MyApp> {
  ...
  // After Seven:7! Years:
  var _spriteXs = List.filled(300, 0.0); // Fixed-length list of doubles initialized to 0.0
  var _types = List.filled(300, 0); // Fixed-length list of integers initialized to 0
  // After Seven:7! Years:
